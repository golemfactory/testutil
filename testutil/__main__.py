...
def scan(payment_network: str, address: Optional[str], url: Optional[str], offset: int, verbose: bool, debug: bool):
    config = CONFIG.get(payment_network)
    asyncio.run(run_scanner(config, address, url, offset, verbose, debug))
